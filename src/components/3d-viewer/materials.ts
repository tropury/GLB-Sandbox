    ...
    options: [
      {
        ...
        texture: "/textures/fabric/fabric-3.png",
        normalMap: FABRIC_NORMAL_MAP,
        // Higher normalScale for light fabrics — makes weave pattern visible
        normalScale: 2.5,
        // With UV range ~12, repeat=0.25 → ~3 tiles across surface
        repeatX: 0.25,
        repeatY: 0.25,
        roughness: 0.75,
        metalness: 0.0,
      ...
      },
      {
        ...
        texture: "/textures/fabric/fabric-1.png",
        normalMap: FABRIC_NORMAL_MAP,
        normalScale: 2.0,
        repeatX: 0.25,
        repeatY: 0.25,
